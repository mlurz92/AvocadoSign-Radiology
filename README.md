...
5.  **Service Layer (`services/`):** Contains the complex business logic for statistics, export, brute-force optimization, and publication generation. The publication service itself is further modularized into individual text generators (`services/publication_service/`).
