window.exportService = (() => {
    ...
    function exportComparisonData(actionId, comparisonData, kollektiv) {
        ...
        if (t2ShortName) options.t2CriteriaLabelShort = t2ShortName;
        if (comparisonCriteriaSet?.logic) options.t2CriteriaLabelFull = window.studyT2CriteriaManager.formatCriteriaForDisplay(comparisonCriteriaSet.criteria, comparisonCriteriaSet.logic);
