window.introductionGenerator = (() => {
    ...
    function generateIntroductionHTML(stats, commonData) {
        ...
        const introText = `
            ...
            <p>The purpose of this study was to test the hypothesis that the Avocado Sign, a contrast-enhancement-based imaging marker, offers diagnostic performance for predicting mesorectal lymph node involvement that is comparable to a cohort-optimized T2-weighted criteria set and superior to established literature-based T2w criteria.</p>
        `;
