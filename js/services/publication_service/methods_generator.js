window.methodsGenerator = (() => {
    ...
    function generateStudyDesignHTML(stats, commonData) {
        ...
        return `
            ...
            <p>This retrospective, single-institution study was compliant with the Health Insurance Portability and Accountability Act and approved by our institutional review board, which waived the requirement for written informed consent. We performed a secondary analysis of a previously described cohort of ${helpers.formatValueForPublication(nOverall, 0)} consecutive patients with histologically confirmed rectal cancer who underwent pelvic MRI for primary staging or restaging between January 2020 and November 2023 ${helpers.getReference('Lurz_Schaefer_2025')}.</p>
