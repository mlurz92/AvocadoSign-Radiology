window.publicationTab = (() => {
    ...
    function _processAndNumberReferences(html, allReferences) {
        ...
        // Corrected regex: Matches [REF_KEY] where REF_KEY consists of word characters (letters, numbers, underscores)
    ...
    function getSectionContentForExport(sectionId, lang, allCohortStats, commonData) {
        // This function seems to be part of an older or external interface for export
        // and is not directly called by render(), but may be used by exportService.
        // It needs to ensure it uses the global publicationService.
    ...
    return Object.freeze({
        render,
        getSectionContentForExport // Expose for exportService
    });
